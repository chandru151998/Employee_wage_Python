...
class Company:
    ...
    def get_emp_as_dict(self):
        ...
        details_dict = {}
        for key, value in self.employee_dict.items():
            details_dict.update({value.emp_name: value.get_emp_dict()})
...
class Companies:
    ...
    def write_to_csv_file(self):
        ...
        """
        try:
            with open("employee_wage.csv", "w", newline='') as write_file:
                fieldnames = ['Employee name', 'Working days', 'Total wage']
    ...
    def write_to_json_file(self):
        """
        Function to write data to jdon file
        """
        try:
            for company_name, company_object in self.company_dict.items():
                emp_dictionary = company_object.get_emp_as_dict()

                self.json_dict.update({company_name: emp_dictionary})

                json_object = json.dumps(self.json_dict, indent=4)
                with open("employee_wage.json", "w") as write_file:
...
def read_from_csv_file():
    ...
    """
    with open("employee_wage.csv", "r") as read_file:
...
def read_from_json_file():
    ...
    Function to read csv file
    """
    with open("employee_wage.json", "r") as read_file:
        json_object = json.load(read_file)
    for key, value in json_object.items():
        print("{:<10} {:<10}".format('Company name', key))
...
def add_employee():
    ...
    companies.write_to_json_file()
    companies.write_to_csv_file()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        choice_dict = {1: add_employee, 2: display_employee,
                       ...
                       7: delete_company, 8: read_from_json_file, 9: read_from_csv_file}
